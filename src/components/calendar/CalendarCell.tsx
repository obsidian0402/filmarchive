...
export function CalendarCell({ dayNumber, proposals, isToday, role, onClick, onProposalClick }: CalendarCellProps) {
    if (dayNumber === null) {
        return <div style={{ background: 'var(--bg-base)', minHeight: '120px' }} />;
    }
